    ...
    return(
        ...
        <div class="w-64 bg-white border-r border-gray-200 pt-4 flex flex-col">
            ...
            <nav class="px-2 pt-3 flex-1">
                ...
                <a href="register4.html" class="flex items-center px-3 py-2 mb-1 rounded-md text-gray-600 hover:bg-gray-50">
                ...
                <a href="register5.html" class="flex items-center px-3 py-2 mb-1 rounded-md text-gray-600 hover:bg-gray-50">
                ...
                <a href="register6.html" class="flex items-center px-3 py-2 mb-1 rounded-md text-gray-600 hover:bg-gray-50">
                    <span class="bg-gray-100 w-5 h-5 rounded-full flex items-center justify-center text-xs mr-2">6</span>
                    <span class="text-sm">Contact</span>
                </a>

                <a href="register7.html" class="flex items-center px-3 py-2 mb-1 rounded-md text-gray-600 hover:bg-gray-50">
                ...
                <a href="register8.html" class="flex items-center px-3 py-2 mb-1 rounded-md text-gray-600 hover:bg-gray-50">
